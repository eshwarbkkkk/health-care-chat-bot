...
class HyperlinkManager:
    ...
    def __init__(self, text):
        self.text = text
        self.text.tag_config("hyper", foreground="red", underline=1)
...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.background_image = self.background_image.resize((1550,1550))  # Resize with a tuple
        self.background_photo = ImageTk.PhotoImage(self.background_image)

        self.canvas = tk.Canvas(master, width=100, height=600)  # Match canvas size to the window
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.background_image = Image.open("image22.jpg")
        self.background_image = self.background_image.resize((1550,1550))  # Resize with a tuple
        self.background_photo = ImageTk.PhotoImage(self.background_image)

        self.canvas = tk.Canvas(master, width=100, height=100)  # Match canvas size to the window
        self.canvas.pack(fill="both", expand=True)
        self.canvas.create_image(0, 0, image=self.background_photo, anchor="nw")
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="orange")
        self.lblMsg.pack()
